                    ...
                    <div class="bgc-white h-100p p-20 bd">
                        ...
                        <div class="mT-30">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('name', old('name', $user->name), ['class' => 'form-control', 'id'=>'name', 'placeholder'=>'Имя']); !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('email', old('email', $user->email), ['class' => 'form-control', 'id'=>'email', 'placeholder'=>'Почта']); !!}
                ...
                <div class=" col-md-6">
                    <div class="bgc-white h-100p p-20 bd">
                        ...
                        <div class="mT-30">
                            ...
                            <input id="thumbnail" class="form-control" type="hidden" name="avatar_path" value="{{old('avatar_path', $user->avatar_path)}}">
                            <div>
                                <img id="holder" style="margin-top:15px;max-height:180px;" src="{{old('avatar_path', $user->avatar_path)}}">
                            </div>
