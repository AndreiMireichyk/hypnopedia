...
@section('js')
    @parent
    <script src="{{asset('/js/blog.bundle.js')}}?{{env('VERSION')}}"></script>
@endsection
...
@section('content')
    <main class="blog">
                        ...
                        <div class="categories__articles top-article tab-pane {{$categories->first()->id === $category->id ? 'active' : ''}}"
                            ...
                            @if($category->articles->count())
                                <div class="top-article__bootom">
                                    <a class="top-article__btn" href="{{route('blog.category', ['locale'=>app()->getLocale(), 'slug'=>$category->slug])}}">@lang('blog.all_news')</a>
                                </div>
                            @endif
                        </div>
                    @endforeach
        ...
        <h1 class="blog__title">@lang('blog.last_news')</h1>
